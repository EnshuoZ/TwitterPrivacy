...
def analyze_semilarity(tex,name):
    ...
    if( similarity>=0.08):
        return "Excellent! you got "+ str(similarity)+' score'
    elif(similarity>=0.060 and similarity<0.08):
        return "Good! you got " +str(similarity)+' score'
    elif(similarity>=0.050 and similarity<0.06):
        return "Nice! you got "+ str(similarity)+' score'
    elif( similarity<0.05):
        return "Unfortunately! you got " +str(similarity)+' score'
